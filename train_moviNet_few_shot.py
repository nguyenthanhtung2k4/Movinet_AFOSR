...
from datasets.tf.afors import AFORSVideoDataGeneratorFewShotLearning
...
def main():
    ...
    train_annotation_file = '/AFOSR/afosr2022/train_few_shot.txt'
    test_annotation_file = '/AFOSR/afosr2022/val_few_shot.txt'
    train_few_shot = ['01.mp4','02.mp4','03.mp4','04.mp4','05.mp4','06.mp4']
    test_few_shot = ['07.mp4','08.mp4','09.mp4','10.mp4','11.mp4','12.mp4']
    ...
    logdir = f'/AFOSR/afosr2022/movinet/savedmodel/few_shot/half/{model_id}/{model_type}/{resolution}/logs/' + datetime.now().strftime("%Y%m%d-%H%M%S")
    checkpoint_filepath = f'/AFOSR/afosr2022/movinet/savedmodel/few_shot/half/{model_id}/{model_type}/{resolution}/checkpoint/cp.cpkt'
    savedmodel_filepath = f'/AFOSR/afosr2022/movinet/savedmodel/few_shot/half/{model_id}/{model_type}/{resolution}/model'
    # image transform
    transform = A.Compose([
    ...
    train_generator = AFORSVideoDataGeneratorFewShotLearning(
        video_dir=video_dir,
        annotation_file_path=train_annotation_file,
        list_class = train_few_shot,
    ...
    test_generator = AFORSVideoDataGeneratorFewShotLearning(
        video_dir=video_dir,
        annotation_file_path=test_annotation_file,
        list_class =test_few_shot,
